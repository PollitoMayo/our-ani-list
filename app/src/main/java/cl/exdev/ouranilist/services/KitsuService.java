...
public interface KitsuService {
    @GET("anime")
    public Call<KitsuResponse> searchAnimeList(@Query("filter[text]") String filterText, @Query("page[limit]") int limit, @Query("page[offset]") int offset, @Query("sort") String sort);
